...
export const WHEEL_SLICES = [
    ...
    { classNames: ['MultiplicationMode'],                        iconKey: 'game-mode-multiplication',    color: 0x5C6BC0, weightKeys: ['multiplication'] },
    { classNames: ['VowelLengthMode'],                           iconKey: 'game-mode-vowellength',       color: 0x00ACC1, weightKeys: ['vowelLength'] },
    { classNames: ['VowelSoundsMode'],                           iconKey: 'game-mode-vowelsounds',       color: 0x8D6E63, weightKeys: ['vowelSounds'] },
    { classNames: ['NumberBondsMode'],                           iconKey: 'game-mode-numberbonds',       color: 0x7CB342, weightKeys: ['numberBonds'] },
